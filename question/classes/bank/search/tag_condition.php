...
class tag_condition extends condition {
    ...
    public function __construct(array $contexts, array $selectedtagids = []) {
        ...
        if ($selectedtagids) {
            ...
            $tagparams['questioncomponent'] = 'quiz_tag_correspondence_17';
    ...
    public function display_options() {
        ...
        $tags = \core_tag_tag::get_tags_by_area_in_contexts('quiz_tag_correspondence_17', 'question', $this->contexts);
