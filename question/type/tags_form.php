...
class tags extends \moodleform {
    ...
    public function definition() {
        ...
        if (\core_tag_tag::is_enabled('quiz_tag_anime_2', 'question')) {
            $tags = \core_tag_tag::get_tags_by_area_in_contexts('quiz_tag_anime_2', 'question', $customdata['contexts']);
            $tagstrings = [];
            foreach ($tags as $tag) {
            ...
            if ($iseditingcontextcourseoractivity && !$iscourseoractivityquestion) {
                ...
                $coursetagheader = get_string('questionformtagheader', 'quiz_tag_anime_2',
